...
<body data-spy="scroll" data-target=".navbar" data-offset="70">
    ...
    <section id="about" class="py-section">
        <div class="container">
            <h4>CRITERIOS PARA ARQUIVOS</h4>
            <br>
            <p>Para seguir com sua com seu cadastro sera preciso enviar alguns documento</p>
            <p>Esses documentos são:</p>
            <ul>
                <li>Foto do documento de indentificação</li>
                <li>Comprovante de residencia</li>
                <li>Video de no maximo 3 minutos de duração</li>
                <li>Indentificação do candidato e da proposta</li>
            </ul>
            <h5>Limite de envio</h5>
            <br>
    ...
    <section class="py-section bg-light">
        <div class="container">
            ...
            <img src="./imgs/imagens/CapCut_mobile_selecao.png" alt="CapCut mobile" class="img-fluid">
            <br>
            ...
            <img src="./imgs/imagens/CapCut_mobile_remove.png" alt="CapCut mobile" class="img-fluid">
            <br>
